...
SUPPORTED_PYTHONS: Final[list[str]] = ["3.10", "3.11", "3.12", "3.13", "3.14"]
...
def install_deps(
    ...
    *,
    ...
    if os.getenv("INSTALL_WITH_PIP") is not None:
        ...
        # install separately in case it conflicts with a just-installed dependency
        # (for overriding a locked dep)
        if dependencies:
